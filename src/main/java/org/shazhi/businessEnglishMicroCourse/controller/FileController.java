...
public class FileController {
    ...
    @RequestMapping("file/{type}/download")
    public void download(HttpServletRequest request, HttpServletResponse response, Session session, @PathVariable String type){
        String range = request.getHeader("Range");

        CoursewareEntity coursewareEntity = new CoursewareEntity()
                .setCoursewareName("hashcode_1098_c1eddaaefcacf1937817db2b6dd56011.f0.mp4")
                .setCoursewarePath("\\cover\\hash")
                .setTotalSize((long) (2*1024*1024*49+1160961))
                .setFragmentSize((long) (2*1024*1024))
                .setFragmentNbr(50);
